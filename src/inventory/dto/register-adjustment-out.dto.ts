 ...
 * los fija internamente (siempre ADJUSTMENT_OUT + MANUAL). El ValidationPipe
 * global (whitelist + forbidNonWhitelisted) rechaza cualquier campo
 * adicional.
 */
export class RegisterAdjustmentOutDto {
  ...
  @ApiProperty({ maxLength: 200, example: 'Ajuste por conteo físico' })
  @IsString()
  @MinLength(1)
  @MaxLength(200)
  reason!: string;
